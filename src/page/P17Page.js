...
class P17Page extends Component {
      ...
      <div className="ppage">
        <div className="title_section">
          ...
          <div className="content_holder">
            ...
            <img src="/weiching-chen/P17/d1.png" width="49%"/>
            <div className="gap_w"></div>
            <img src="/weiching-chen/P17/d1.png" width="49%"/>

            <div className="gap_h"></div>

            <img src="/weiching-chen/P17/d2.png" width="49%"/>
            <div className="gap_w"></div>
            <img src="/weiching-chen/P17/d3.png" width="49%"/>
            ...
            <div className="more_detail">
              <h4>More Details</h4>
              <p>Learn more about the project: <a href="https://www.doday.com.tw">[Website]</a><a href="https://github.com/nexuni/DodayOfficialWebsite.git">[GitHub]</a></p>
              <h4>Project Type</h4>
